...
class CommandHandler 
{
    ...
    {
        $this->db->setStatement("INSERT INTO t:lw_in_user (intranet_id, name, password, email, lw_first_date, opt1text, opt2text) VALUES (:intranet_id, :name, :password, :email, :lw_first_date, :opt1text, :opt2text) ");
    ...
    {
        #print_r($uObj->getUserData());die();
        $this->db->setStatement("UPDATE t:lw_in_user SET intranet_id = :intranet_id, name = :name, password = :password, email = :email, opt1text = :firstname, opt2text = :lastname WHERE id = :id ");
